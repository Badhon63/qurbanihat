      ...
      <section className="mt-16">
        ...
        <div className="space-y-3 text-gray-700">
          <p className="border p-3 rounded-lg">
            Choose healthy animals with proper weight
          </p>
          <p className="border p-3 rounded-lg">
            Check age and health condition
          </p>
          <p className="border p-3 rounded-lg">Avoid weak or sick animals</p>
          <p className="border p-3 rounded-lg">
            Ensure proper care before purchase
          </p>
        </div>
      </section>
    </div>
